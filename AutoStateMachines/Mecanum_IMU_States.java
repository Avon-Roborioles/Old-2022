...
public class Mecanum_IMU_States {
    ...
    public void makeCorrectionsStraight(int inchesSign) {
        getTelemetry();
    ...
    public void makeCorrectionsStrafeLeft() {
    ...
    public void makeCorrectionsStrafeRight() {
        correction = checkDirection() * tipsyturnsy;
        //if positive correction needed, needs to go counter-clockwise -> adds power to front
        //if negative, needs to go clockwise -> adds power to back
    ...
    public void setGoToSpot(double inches, double power) {
        inches *= 91;
